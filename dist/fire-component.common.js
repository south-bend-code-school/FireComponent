...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"firecomponent--image-editor--vertical-aligner\">", "</div>", [_vm._ssrNode("<div" + (_vm._ssrStyle(null, null, {
    display: (!_vm.uploading) ? '' : 'none'
  })) + ">", "</div>", [_vm._t("croppie-header", [_c('h1', {
    staticClass: "firecomponent--image-editor--header"
  }, [_vm._v("Crop Photo")])]), _vm._ssrNode(" <div class=\"firecomponent--image-editor--croppie-wrapper\"><div></div></div> "), _vm._ssrNode("<div class=\"firecomponent--image-editor--controls\">", "</div>", [_vm._t("croppie-controls", [(_vm.allowOrientation) ? _c('button', {
    ...
    cancel: _vm.cancel,
    upload: _vm.upload
  })], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"firecomponent--image-editor--uploading-controls\"" + (_vm._ssrStyle(null, null, {
    display: (_vm.uploading) ? '' : 'none'
  })) + ">", "</div>", [_vm._t("uploading", [_c('button', {
    staticClass: "firecomponent--button",
    on: {
      "click": _vm.cancel
    }
